...
<head>
    ...
    <!-- For Kalender -->
    <!-- <script src="<?= base_url('assets/') ?>plugins/fullcalendar/fullcalendar.css"></script>
    <script src="<?= base_url('assets/') ?>plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css"></script>
