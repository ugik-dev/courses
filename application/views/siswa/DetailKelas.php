...
`
            ...
            if (end < bln) {
                ...
                for (p = bln; p <= end; p++) {
                    if (p > 12) {
                        bulantabs = bulantabs + `<button class="changebulan btn active btn-success btn-sm" data-id="${p}"  id="btn_bln_${p}" >${months[parseInt(p)-12]}</button>`
                    } else {

                        bulantabs = bulantabs + `<button class="changebulan btn active btn-success btn-sm" data-id="${p}"  id="btn_bln_${p}" >${months[p]}</button>`
                    }
                }
                end = parseInt(end) - 12;
            } else {
            ...
            <button class="save-absen btn btn-success my-1 mr-sm-2" type="submit" id="save_absen" data-loading-text="Loading..."><strong>Save</strong></button>
                                 </form></div>`;
