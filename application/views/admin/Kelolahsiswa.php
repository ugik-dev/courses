...
$(document).ready(function() {
  ...
  function getAllRole(){
    return $.ajax({
      url: `<?php echo site_url('KelolahuserController/getAllRoleOption/')?>`, 'type': 'GET',
      data: {},
  ...
  function getKelolahuser(){
    return $.ajax({
      url: `<?php echo site_url('KelolahuserController/getAllKelolahUser/')?>`, 'type': 'POST',
   ...
   function renderRoleSelection(data){
    ...
    KelolahuserModal.id_role.append($('<option>', { value: "", text: "-- Pilih Role --"}));
  ...
  function renderKelolahuser(data){
    ...
    Object.values(data).forEach((user) => {
      ...
      `;
      renderData.push([user['username'],user['nama'], user['tahun_masuk'], button]);
    });
  ...
  FDataTable.on('click','.delete', function(){
    ...
    swal(swalDeleteConfigure).then((result) => {
      ...
      $.ajax({
        url: "<?=site_url('KelolahuserController/deleteKelolahuser')?>", 'type': 'POST',
        data: {'id_user': id},
        success: function (data){
          var json = JSON.parse(data);
          if(json['error']){
  ...
  function addKelolahuser(){
    swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('KelolahuserController/addUser')?>`, 'type': 'POST',
  ...
  function editKelolahuser(){
    swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('KelolahuserController/editKelolahuser')?>`, 'type': 'POST',
        data: KelolahuserModal.form.serialize(),
        success: function (data){
  ...
  function editPassword(){
    swal(swalSaveConfigure).then((result) => {
      ...
      $.ajax({
        url: `<?=site_url('KelolahuserController/editPassword')?>`, 'type': 'POST',
