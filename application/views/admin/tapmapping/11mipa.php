<div role="tabpanel" id="tab-33" class="tab-pane">
    <div class="panel-body">
        <div class="form-group">
            <div class="row m-t-sm">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table id="FDataTable_11_mipa" class="table table-bordered table-hover" style="padding:0px">
                            <thead>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        var FDataTable_11_mipa = $('#FDataTable_11_mipa').DataTable({
            'columnDefs': [{
                targets: [1],
        ...
        function getAllMapel_11_mipa() {
            ...
            return $.ajax({
                ...
                success: function(data) {
                    ...
                    render_11_mipa(dataMapel10Mipa);
                },
                error: function(e) {}
            });
        }
        ...
        function render_11_mipa(data) {
            ...
            FDataTable_11_mipa.clear().rows.add(renderData).draw('full-hold');
        };

        FDataTable_11_mipa.on('click', '.nonactive', function() {
        ...
        FDataTable_11_mipa.on('click', '.act', function() {
            console.log('act');
            var id = $(this).data('id');
            console.log(id)
            swal({
        ...
        FDataTable_11_mipa.on('click', '.create', function() {
            console.log('create');
