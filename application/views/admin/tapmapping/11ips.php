<div role="tabpanel" id="tab-44" class="tab-pane">
    <div class="panel-body">
        <div class="form-group">
            <div class="row m-t-sm">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table id="FDataTable_11_ips" class="table table-bordered table-hover" style="padding:0px">
                            <thead>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        var FDataTable_11_ips = $('#FDataTable_11_ips').DataTable({
            'columnDefs': [{
                targets: [1],
        ...
        function render_11_ips(data) {
            ...
            FDataTable_11_ips.clear().rows.add(renderData).draw('full-hold');
        };

        FDataTable_11_ips.on('click', '.nonactive', function() {
        ...
        FDataTable_11_ips.on('click', '.act', function() {
            console.log('act');
            var id = $(this).data('id');
            console.log(id)
            swal({
        ...
        FDataTable_11_ips.on('click', '.create', function() {
            console.log('create');
