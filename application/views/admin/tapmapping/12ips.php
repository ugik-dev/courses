            ...
            <div class="row m-t-sm">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table id="FDataTable_12_ips" class="table table-bordered table-hover" style="padding:0px">
                            <thead>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        var FDataTable_12_ips = $('#FDataTable_12_ips').DataTable({
            'columnDefs': [{
                targets: [1],
        ...
        function render_12_ips(data) {
            ...
            FDataTable_12_ips.clear().rows.add(renderData).draw('full-hold');
        };

        FDataTable_12_ips.on('click', '.nonactive', function() {
        ...
        FDataTable_12_ips.on('click', '.act', function() {
            console.log('act');
            var id = $(this).data('id');
            console.log(id)
            swal({
        ...
        FDataTable_12_ips.on('click', '.create', function() {
            console.log('create');
