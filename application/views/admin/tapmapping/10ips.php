            ...
            <div class="row m-t-sm">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table id="FDataTable_10_ips" class="table table-bordered table-hover" style="padding:0px">
                            <thead>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        var FDataTable_10_ips = $('#FDataTable_10_ips').DataTable({
            'columnDefs': [{
                targets: [1],
        ...
        function render_10_ips(data) {
            ...
            FDataTable_10_ips.clear().rows.add(renderData).draw('full-hold');
        };

        FDataTable_10_ips.on('click', '.nonactive', function() {
        ...
        FDataTable_10_ips.on('click', '.act', function() {
            console.log('act');
            var id = $(this).data('id');
            console.log(id)
            swal({
        ...
        FDataTable_10_ips.on('click', '.create', function() {
            console.log('create');
