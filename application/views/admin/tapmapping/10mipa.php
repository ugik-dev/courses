            ...
            <div class="row m-t-sm">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table id="FDataTable_10_mipa" class="table table-bordered table-hover" style="padding:0px">
                            <thead>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        var FDataTable_10_mipa = $('#FDataTable_10_mipa').DataTable({
            'columnDefs': [{
                targets: [1],
        ...
        function getAllMapel_10_mipa() {
            ...
            return $.ajax({
                ...
                success: function(data) {
                    ...
                    render_10_mipa(dataMapel10Mipa);
                },
                error: function(e) {}
            });
        }
        ...
        function render_10_mipa(data) {
            ...
            FDataTable_10_mipa.clear().rows.add(renderData).draw('full-hold');
        };

        FDataTable_10_mipa.on('click', '.nonactive', function() {
        ...
        FDataTable_10_mipa.on('click', '.act', function() {
            console.log('act');
            var id = $(this).data('id');
            console.log(id)
            swal({
        ...
        FDataTable_10_mipa.on('click', '.create', function() {
            console.log('create');
